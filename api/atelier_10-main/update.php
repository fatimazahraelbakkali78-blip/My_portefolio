  ...
  <div class="mx-auto w-50">
    ...
    <form action="update.php?id=<?=$id?>"  method="POST"     enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="form-group">
        <label>Ville:</label>
        <input name="ville" type="text" class="form-control" value="<?php echo $ville?>">
      </div>
	 <div class="form-group">
        <label>Photo:</label>
        ...
        <input type="submit" name="Modifier" class="btn btn-outline-light" value="Modifier"/>
...
if(!empty($_POST['Modifier']))
{
    ...
    $r= Tstutents::UpdateStudent($id, $nom, $prenom, $ville, $phototem, $photodes);
    
    
    
    
   //echo "$id--$nom--$prenom--$ville--";
}
